import { ScrambleText, SparkleIcon, LanguageSwitcher } from "@/shared/ui";
  ...
  return (
    <header className="mb-[38px] animate-rise">
      <div className="mb-[22px] flex items-center justify-between gap-3">
        <div className="type-home-eyebrow group inline-flex items-center gap-[0.6em] rounded-pill bg-pitch px-[13px] py-[7px] text-white">
